...
void EditorMapUiMgr::Init()
{
	...
	selects = { "TILE","TREE","BUSH","STONE","BLOCK","RADIATION","PLAYER","ENEMY", "BOSS","BOX","ANOTHER"};
	selectTxtSize = { 75,75,75,65,65,40,55,60,60,75,40 };
	selectPosY = { 54,54,54,54,54,70,62,54,54,54,70 };
