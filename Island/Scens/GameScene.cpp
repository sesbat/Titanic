...
void GameScene::SupplyUpdate(float dt)
{

    {
        if (InputMgr::GetKeyDown(Keyboard::F3))
        {
            ...
            ment->SetText(*RESOURCES_MGR->GetFont("fonts/NotoSansKR-Medium.otf"), 24, Color::White, L"����ǰ�� �����Ǿ����ϴ�");
    ...
    if (!isSupply)
    {
        ...
        if (supplyTimer > initSupplyTimer)
        {
            ...
            ment->SetUiViewCenter(true);
            ment->SetUiView(&uiView);
            ment->SetText(*RESOURCES_MGR->GetFont("fonts/NotoSansKR-Medium.otf"), 24, Color::White, "����ǰ�� �����Ǿ����ϴ�");
            ment->SetOrigin(Origins::MC);
            ment->SetTimer(2);
            ment->SetAlways(false);
            ment->SetActive(true);
            ment->GetText().setString(L"����ǰ�� �����Ǿ����ϴ�");
            objList[LayerType::Object][1].push_back(ment);
