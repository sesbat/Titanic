...
void QuadTree::insert(std::vector<Object*> const& ptrArray)
{
    for(auto const& ptr : ptrArray)
        mRoot.insert(static_cast<Object*>(ptr));
}
...
std::vector<Object*> QuadTree::getCollisionable(sf::FloatRect const& bounds) const
{
